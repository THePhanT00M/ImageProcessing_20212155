...
// ImageProcessing_20212155Doc.cpp: CImageProcessing20212155Doc 클래스의 구현
//
...
// CImageProcessing20212155Doc

IMPLEMENT_DYNCREATE(CImageProcessing20212155Doc, CDocument)

BEGIN_MESSAGE_MAP(CImageProcessing20212155Doc, CDocument)
END_MESSAGE_MAP()


// CImageProcessing20212155Doc 생성/소멸

CImageProcessing20212155Doc::CImageProcessing20212155Doc() noexcept
{
...
BOOL CImageProcessing20212155Doc::OnNewDocument()
{
...
// CImageProcessing20212155Doc serialization

void CImageProcessing20212155Doc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
// 축소판 그림을 지원합니다.
void CImageProcessing20212155Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CImageProcessing20212155Doc::InitializeSearchContent()
{
...
void CImageProcessing20212155Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
// CImageProcessing20212155Doc 진단

#ifdef _DEBUG
void CImageProcessing20212155Doc::AssertValid() const
{
	CDocument::AssertValid();
}

void CImageProcessing20212155Doc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
// CImageProcessing20212155Doc 명령


int CImageProcessing20212155Doc::LoadImageFile(CArchive& ar)
{
	int maxValue, i;
...
void CImageProcessing20212155Doc::LoadSecondImageFile(CArchive& ar)
{
	int w, h, d;
	int maxValue, i;
	char type[16], buf[256];
	...
	if (imageWidth != w || imageHeight != h || depth != d) {
		AfxMessageBox("두번쨰 파일의 width, height가 다르면 읽을 수 없습니다.");
		return;
	}
